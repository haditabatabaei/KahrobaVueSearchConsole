                        ...
                        <div class="form-group">
                          <div class="input-group input-group-alternative mb-4">
                            ...
                            <input class="form-control form-control-alternative"
                                   ...
                                   v-model="inputData.universityName">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="input-group input-group-alternative mb-4">
                            ...
                            <input class="form-control form-control-alternative"
                                   placeholder="University Field" type="text"
                                   v-model="inputData.universityField">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="input-group input-group-alternative mb-4">
                            ...
                            <input class="form-control form-control-alternative"
                                   placeholder="Company Job Title" type="text"
                                   v-model="inputData.companyPosition">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <div class="input-group input-group-alternative mb-4">
                            ...
                            <input class="form-control form-control-alternative"
                                   placeholder="Journal Title" type="text"
                                   v-model="inputData.journalTitle">
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  export default {
    ...
    methods: {
      ...
      searchByName: function () {
        ...
        window.console.log('searching by name finished.');
        return number;
      },

      searchByUniversityField: function () {
        let number = 0;
        window.console.log("searching by university field...");
        if (!(this.inputData.universityField == null || this.inputData.universityField.length == 0)) {
          let tempResult = [];
          for (let i = 0; i < this.searchResultProfiles.length; i++) {
            for (let j = 0; j < this.searchResultProfiles[i]["universities"].length; j++) {
              if (this.searchResultProfiles[i]["universities"][j]["field of study"] != null) {
                if (this.searchResultProfiles[i]["universities"][j]["field of study"].toLowerCase().includes(this.inputData.universityField.toLowerCase())) {
                  tempResult.push(this.searchResultProfiles[i]);
                  number++;
                  break;
                }
        ...
        window.console.log('searching by university field finished.');
        return number;
      },

      searchByCompanyName: function () {
        let number = 0;
        window.console.log("searching by company name...");
        if (!(this.inputData.companyName == null || this.inputData.companyName.length == 0)) {
          let tempResult = [];
          for (let i = 0; i < this.searchResultProfiles.length; i++) {
            for (let j = 0; j < this.searchResultProfiles[i]["experiences"].length; j++) {
              if (this.searchResultProfiles[i]["experiences"][j]["company"] != null) {
                if (this.searchResultProfiles[i]["experiences"][j]["company"].toLowerCase().includes(this.inputData.companyName.toLowerCase())) {
                  tempResult.push(this.searchResultProfiles[i]);
                  number++;
                  break;
                }
        ...
        window.console.log('search by company name.');
        return number;
      },

      searchByCompanyPos: function () {
        let number = 0;
        window.console.log("searching by company position...");
        if (!(this.inputData.companyPosition == null || this.inputData.companyPosition.length == 0)) {
          let tempResult = [];
          for (let i = 0; i < this.searchResultProfiles.length; i++) {
            for (let j = 0; j < this.searchResultProfiles[i]["experiences"].length; j++) {
              if (this.searchResultProfiles[i]["experiences"][j]["title"] != null) {
                if (this.searchResultProfiles[i]["experiences"][j]["title"].toLowerCase().includes(this.inputData.companyPosition.toLowerCase())) {
                  tempResult.push(this.searchResultProfiles[i]);
                  number++;
                  break;
                }
        ...
        window.console.log('search by company position finished.');
      },

      searchByCountry: function () {
        let number = 0;
        console.log('search by country started');
        let tempResult = [];
        ...
        console.log('search by country finished.');
        return number;
      },

      searchByUniversityName: function () {
        let number = 0;
        console.log('university search started');
        if (!(this.inputData.universityName == null || this.inputData.universityName.length == 0)) {
          let tempResult = [];
          for (let i = 0; i < this.searchResultProfiles.length; i++) {
            for (let j = 0; j < this.searchResultProfiles[i]["universities"].length; j++) {
              if (this.searchResultProfiles[i]["universities"][j]["name"] != null) {
                if (this.searchResultProfiles[i]["universities"][j]["name"].toLowerCase().includes(this.inputData.universityName.toLowerCase())) {
                  tempResult.push(this.searchResultProfiles[i]);
                  number++;
                  break;
                }
        ...
        console.log('university search finished.');
        return number;
      },

      searchByJournalTitle: function () {
        let number = 0;
        console.log('journal search started.');
        if (!(this.inputData.journalTitle == null || this.inputData.journalTitle.length == 0)) {
          let tempResult = [];
          for (let i = 0; i < this.searchResultProfiles.length; i++) {
            for (let j = 0; j < this.searchResultProfiles[i]["journals"].length; j++) {
              if (this.searchResultProfiles[i]["journals"][j]["title"] != null) {
                if (this.searchResultProfiles[i]["journals"][j]["title"].toLowerCase().includes(this.inputData.journalTitle.toLowerCase())) {
                  tempResult.push(this.searchResultProfiles[i]);
                  number++;
                  break;
                }
        ...
        window.console.log('journal search finished.');
        return number;
      },
      ...
      search: function () {
        ...
        this.searchByName();
        this.searchByUniversityName();
        this.searchByUniversityField();
        this.searchByCompanyName();
        this.searchByCompanyPos();
        this.searchByJournalTitle();
